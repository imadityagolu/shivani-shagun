    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center p-1 sm:p-0">
      <div className="bg-white p-4 sm:p-8 rounded-lg shadow-md w-full max-w-md mx-2 sm:mx-auto">
        <div className="flex justify-center mb-6">
          <Link to="/AdminLogin"><FaUserCircle className="w-12 h-12 text-rose-500" /></Link>
        </div>
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 text-center mb-6">Customer Sign in</h2>
        <div className="space-y-4">
          ...
          <div className="flex justify-end text-sm">
            <Link to="/ResetPassword" className="text-rose-500 hover:underline">Forgot password? Reset.</Link>
          </div>
          <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-2 sm:gap-0">
            <Link to="/Signup" className="text-rose-500 font-medium hover:underline">Don't have an account? Sign up</Link>
            <button
