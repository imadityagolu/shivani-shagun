...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${BACKEND_URL}/api/customer/signup`, {
        method: 'POST',
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center p-1 sm:p-0">
      <div className="bg-white p-4 sm:p-8 rounded-lg shadow-md w-full max-w-md mx-2 sm:mx-auto">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 text-center mb-6">Create Account for Customer</h2>
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-2 sm:gap-0">
            <Link to="/Login" className="text-rose-500 font-medium hover:underline">Already have an account? Sign in</Link>
            <button
