    ...
    <footer className="bg-gradient-to-r from-rose-100 to-pink-100 text-gray-700 py-10 mt-12 border-t border-rose-200">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm mb-1">Email: <a href="mailto:info@shivanishagun.com" className="text-rose-600 hover:underline">info@shivanishagun.com</a></p>
          <p className="text-sm mb-1">Phone: <a href="tel:+919999999999" className="text-rose-600 hover:underline">+91 99999 99999</a></p>
          <p className="text-sm">Address: Giyatri Palace, Meena Bazar,<br/>Patna City, Patna, Bihar, India.</p>
        </div>
        {/* Social Media */}
        <div>
          <h3 className="text-lg font-bold text-rose-500 mb-3">Follow Us</h3>
          <div className="flex gap-4 mt-2">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-rose-500 hover:text-rose-700 text-2xl transition"><FaInstagram /></a>
